 ...
 * be mapped.
 */
constexpr u32 ENCORE_PAGE_SIZE = 0x1000;
constexpr u32 ENCORE_PAGE_MASK = ENCORE_PAGE_SIZE - 1;
constexpr int ENCORE_PAGE_BITS = 12;
constexpr std::size_t PAGE_TABLE_NUM_ENTRIES = 1 << (32 - ENCORE_PAGE_BITS);
