...
2. Input the currently supported extensions from [here](https://github.com/CasualPokePlayer/encore/blob/headless/externals/glad/include/glad/glad.h#L9), plus any new required extensions.
